...
// @connect      127.0.0.1
// @connect      localhost
// @downloadURL  https://raw.githubusercontent.com/wzgrx/hua-yi-helper/main/src/tampermonkey/hua-yi-helper.user.js?v=8.8.2
// @updateURL    https://raw.githubusercontent.com/wzgrx/hua-yi-helper/main/src/tampermonkey/hua-yi-helper.user.js?v=8.8.2
// ==/UserScript==
...
(function () {
  ...
  var VERIFIED = [["“循之累累然乃刺之”出自（）","《素问·刺腰痛论》","B"],["“脏腑别通”之理论源于（）","《医学入门 ·脏腑相通篇》","E"],["（）是肺部疾病中最容易获得的标本之一其蛋白质谱的变化能够反映肺损伤及修复过程","肺泡灌洗液","A"],["（课前）结合目前所学知识，对于首次诊断T2DM的患者，若其合并ASCVD或CVD高危，应考虑优先使用哪类药物？","具有CVD获益证据的GLP-1RA或SGLT2i","C"],["《中国阿尔茨海默病痴呆诊疗指南（2020年版）》指出ad药物治疗的核心原则不包括？","根治疾病"],["2007年iwg-1标准中诊断可能的ad的核心要求是？","早期显著情景记忆损伤+至少1项支持性特征"],["2024年iwg-4标准中将认知功能正常但具有特定生物标志物模式的个体定义为？","AD高风险人群"],["2型糖尿病防治指南中除血糖和糖化血红蛋白的达标外理想血压是（）","＜130/80mmHg","B"],["阿尔茨海默病（ad）患者在功能性磁共振成像（fmri）检查中实施学习和回忆任务时的典型表现为？","额叶前区和颞叶内侧皮质激活区域缩小，信号强度降低"],["阿尔茨海默病的典型病理改变不包括以下哪项？","路易小体"],["阿尔茨海默病的非药物治疗中不属于心理治疗的是？","音乐疗法","B"],["阿尔茨海默病全病程管理的核心是？","以单个病人为中心的照护模式","B"],["柏林标准中ards的严重程度分级为（）","轻度、中度和重度","B"],["爆发性心肌炎患者合并ⅲ度房室传导阻滞应（）","临时起搏器+ECMO","A"],["鼻窦炎以（）最常见","上颌窦","A"],["鼻渊的别名不包括（）","脑透","E"],["常用气道廓清技术包括以下哪些（）","指导性咳嗽、主动循环呼吸技术、自主引流、呼气末正压/振动呼气末正压、高频胸壁振荡、体位引流、运动/活动、手法辅助咳嗽、机械式吸入呼出装置、气道抽吸","A"],["痴呆临床表现的abc症状中a代表的是？","日常生活能力下降"],["磁共振波谱成像（mrs）中ad最早期的波谱变化为？","NAA/Cr 比值降低，MI/Cr 比值升高"],["单一出现时需与颞叶癫痫或颞叶器质性损害鉴别的幻觉类型是？","幻嗅"],["胆经的穴位不包括（）","地仓透颊车","D"],["导致血浆ad生物标志物检测存在挑战的因素不包括？","单一样本可检测多项标志物"],["典型ad患者最早出现的临床症状是哪种记忆障碍？","情景记忆障碍"],["调节炎症反应的重要因子是（）","MicroRNA（miRNA）","C"],["多因素分析显示高tg导致2型糖尿病患者血糖控制不佳风险增加（）倍","1.63","B"],["耳胀的病因病机不包括（）","肝阳上亢","E"],["肺泡巨噬细胞（am）是肺部最丰富的免疫细胞且在ards的发生发展中扮演重要角色am作用不包括（）","促进损伤","E"],["俯卧位通气的主要作用不包括以下哪一项（）","导致肺泡塌陷","D"],["俯卧位通气时最常见的不良反应是（）","低血压","A"],["根据“脏腑别通”错误的是（）","肝与命门相通","C"],["根据2014年iwg-2标准阿尔茨海默病（ad）相关的生物标志物被明确分为哪两类？","诊断性标志物和进展性标志物"],["根据2026年ada糖尿病诊疗标准对于已确诊ascvd或高风险的t2dm患者在降糖药物选择上应优先考虑哪类药物？","GLP-1RA或SGLT2i","A"],["根据nia-aa2011版诊断标准下列哪项不属于“很可能的ad痴呆”核心临床标准中的早期突出认知损害表现？","早期即出现显著的人格改变和行为异常"],["共病管理模式的要素不包括以下哪项？","完全依赖社区志愿者管理","E"],["关于《黄帝内经》开阖枢理论错误的是（）","太阳为阖","E"],["关于阿尔茨海默病（ad）的临床表现三联征以下哪项描述最为准确？","认知障碍（Cognition）、精神行为症状（BPSD）、日常生活能力受损（ADL）"],["关于肝性脑病下列说法不正确的是？","前期出现昏迷"],["关于膈肌肌电图（emg）在膈肌疲劳时的表现下列说法正确的是（）","低频成分（30~50Hz）增加，高频成分（130~250Hz）减少","C"],["关于过量异位脂肪与t2dm患者cvd风险的关系以下描述正确的是？","心血管及心肾疾病风险的加速上升往往在明显T2DM出现之前就已开始","C"],["关于基因检测的推荐意见以下哪项是正确的？","有明确痴呆家族史的患者应进行基因检测（A级推荐）"],["关于简易精神状态检查（mmse）的缺点下列说法错误的是？","不受教育程度影响"],["关于认知障碍的病因分类以下哪项描述符合变性性认知障碍的特点？","隐匿起病，进行性加重，症状不可逆"],["关于行为变异型额颞叶痴呆不属于核心临床表现-行为症状的是？","找词困难和命名障碍"],["关于血管性认知障碍（vci）的newcastle分型下列哪项描述正确？","VI型指伴AD的脑血管病变"],["关于阻塞性睡眠呼吸暂停（osa）对ad的影响以下哪项错误？","AD患者对CPAP治疗的耐受性极好","E"],["关于ad患者共病的流行病学特点说法正确的是？","65 岁以上老年痴呆患者共病发生率更高","D"],["关于ad血液生物标志物以下哪项描述是正确的？","家族性AD患者血浆总Aβ或Aβ42水平增高"],["关于ad诊断中生物标志物的应用原则以下哪项是错误的？","生物标志物阳性即可确诊AD，无需结合临床症状"],["关于ad治疗药物的用药安全以下哪项是正确的？","多奈哌齐若出现肝肾功能损害，应考虑减量或停药","C"],["关于apacheii评分描述有误的是（）","是专门为ARDS设计的","B"],["关于ards患者的液体管理以下哪项说法是正确的（）","限制液体管理可减少呼吸机依赖时间","B"],["关于ards患者使用ecmo的适应证以下错误的是（）","ARDS病程超过3个月仍未改善","C"],["关于aβ的清除途径以下说法正确的是？","脑部主要通过蛋白酶降解、血脑屏障清除等途径清除"],["关于bpsd的临床特点以下表述错误的是？","精神症状仅在痴呆中晚期出现"],["关于bpsd诊治的误区说法错误的是？","重视社会心理干预的核心作用"],["关于gip和glp-1受体在中枢神经系统的分布以下描述正确的是？","均存在于大脑中负责调控能量平衡的区域，但分布位置不完全相同","A"],["关于pdi和pdimax的描述正确的是（）","Pdi波形峰值时间是早期疲劳的敏感指标","C"],["国内指南指出ad伴发精神行为症状的药物干预核心原则为？","抗痴呆治疗为基本，必要时使用精神药物"],["过量异位脂肪在t2dm患者cvd发生中起\"上游\"作用其导致cvd风险升高的主要途径是？","通过升高血压和导致血脂水平异常来增加CVD风险","B"],["缓解2型糖尿病的方法有（）","以上皆是","D"],["荟萃分析显示患有黄斑水肿的糖尿病患者的（）水平较高","血清甘油三酸酯","A"],["火针的使用注意事项下面描述错误的是","宁深勿浅","A"],["基础胰岛素通常在什么时间注射（）","睡前注射","C"],["急性肺动脉栓塞的典型影像学表现为（）","肺动脉充盈缺损","A"],["急性肺动脉栓塞患者通常不会出现以下哪种症状（）","端坐呼吸","D"],["间充质基质细胞（mscs）的主要来源不包括以下哪一项（）","心脏组织","D"],["间质性肺疾病（ild）的主要病理生理机制是（）","慢性炎症及纤维化重构","B"],["进行内侧颞叶萎缩评估（mta）的标准影像学层面为？","冠状位 T1WI，脑桥前面水平通过海马体部层面"],["经颅直流电刺激（tdcs）的阳极刺激作用是？","增强刺激部位神经元的兴奋性"],["空腹血糖的值是（）","4.4~7.0","A"],["六种火针的选择法中一般疾病均以哪种火针为主","细火针","A"],["路易体痴呆（dlb）的bpsd核心特点是？","幻觉早而明显"],["美金刚显著预防ad患者以下哪项bpsd症状的发生？","激越/攻击"],["脑脊液标本处理中受检测前因素影响最大的标志物是？","Aβ42"],["溺水者继发感染最常见的病原体是（）","铜绿假单胞菌","B"],["溺水者ecmo的适用条件是（）","PaO?/FiO?<100mmHg且常规通气无效","A"],["评估mda5-dm治疗反应的关键检查是（）","高分辨率CT（HRCT）肺窗","B"],["轻度认知障碍（mci）诊断的核心标准不包括？","符合痴呆的诊断标准","D"],["人体第五大生命体征是（）","疼痛","A"],["认知障碍自评量表（ad8）的评分标准中提示需进一步临床评估的总分阈值是？","≥2 分"],["妊娠合并急性上呼吸道感染终止妊娠的指征不包括（）","胎儿畸形","D"],["生理状态下白色脂肪组织在脂质代谢中的关键功能是？","作为膳食甘油三酯的关键''缓冲区''","B"],["失读的病变部位主要是？","顶下小叶的缘上回和角回"],["属于强效高选择性5-羟色胺（5-ht）再摄取抑制剂的ad治疗药物是？","帕罗西汀"],["糖尿病并发症或相关疾病中患病率最高的是（）","高血压","C"],["糖尿病患者死亡的最主要原因是（）","大血管并发症","B"],["糖尿病患者运动的禁忌症错误的是（）","体重超重的2型糖尿病患者","C"],["糖尿病运动原则（）","以上都是","D"],["体育锻炼对ad患者bpsd的影响是？","显著改善抑郁症状，整体BPSD无显著改善"],["我国现阶段早发2型糖尿病有哪些代谢指标异常（）","以上皆是","D"],["我国t2dm患者合并心血管代谢危险因素的情况以下哪项描述正确？","我国T2DM患者中约六成合并高血压","C"],["下列关于锋勾针的说法正确的是","以上全是","E"],["下列关于喉痹说法有误的是（）","病程短","D"],["下列哪项不是ards的早期症状（）","胸痛","D"],["下列哪项不属于ad的脑相关危险因素？","2型糖尿病"],["下列哪一项不是ards的评估工具（）","GCS昏迷评分","C"],["下面哪一项不是ards的肺内病因（）","重症急性胰腺炎","E"],["相较于pet影像脑脊液生物标志物的优势不包括?","无创性检测"],["心源性肺水肿患者通常不会出现以下哪种症状（）","呼吸困难进行性加重","D"],["新九针的特性包括","以上都是","D"],["新九针发明者是","师怀堂","B"],["新九针改革创新的过程中下面哪种针没有改动过","三棱针","A"],["新九针和古九针的区别下面哪一项是错误的","长针改成火针","B"],["新九针之火针是使用哪种金属制成的","钨","C"],["胰岛素吸收最快的部位（）","腹部","D"],["胰腺炎合并腹腔高压（iah）时首要处理是（）","降低潮气量至4-6ml/kg","B"],["以下不是ali/ards主要病理特征的是（）","肺容积增高","B"],["以下不属于ad患者精神病性症状的是？","抑郁"],["以下关于呼吸康复的描述哪一项是正确的（）","无禁忌症的ARDS患者应尽早进行呼吸康复训练","C"],["以下关于机械通气对脑损伤影响的描述哪一项是正确的（）","机械通气通过多种机制，包括炎症介质释放、颅内压变化和高碳酸血症，影响脑损伤","C"],["以下关于谵妄五种表型与ards预后关系的描述哪一项是正确的（）","低氧血症相关谵妄：与较高的长期认知功能障碍风险相关","C"],["以下关于ards幸存者的肺部影像学改变的描述哪一项是错误的（）","高分辨CT：主要用于评估肌萎缩","B"],["以下关于bpsd的定义描述正确的是？","认知障碍患者经常出现的紊乱的感知觉、思维内容、心境和行为症状"],["以下哪项不是bpsd造成的不良后果？","减慢痴呆患者认知功能下降速度"],["以下哪项不属于认知障碍诊治原则？","晚期诊断痴呆后再开展干预治疗","E"],["以下哪项不属于bpsd中的睡眠障碍类型？","易激惹"],["以下哪项是评估痴呆患者精神行为症状的常用量表？","NPI"],["以下哪项是ad的特征性萎缩表现对早发型ad尤为重要？","楔前叶+顶叶萎缩"],["以下哪项属于bpsd早期识别量表？","神经精神问卷（NPI）"],["以下哪一个不是超重和肥胖的t2dm患者进行体重管理可以得到的获益（）","改善胰岛素抵抗和α细胞功能","D"],["以下哪一项不是时间控制自适应通气（tcav）的潜在优势（）","增加呼吸机相关性肺损伤","D"],["以下哪种疾病不属于变性性认知障碍？","血管性痴呆（VaD）"],["以下哪种量表主要用于评估痴呆患者的日常生活功能？","ADL"],["以下哪种生物标志物在阿尔茨海默病患者中其水平变化早于海马萎缩和临床症状的出现？","CSF Aβ42"],["以下哪种血液生物标志物可用于预测脑内aβ病理改变和ad转化率？","血浆Aβ42/40比值"],["以下属于激越中身体非攻击性行为的是？","不恰当的处理事情"],["以下属于激越中言语攻击性行为的是？","发出怪声"],["用于ad患者睡眠障碍治疗可增强脑内γ-氨基丁酸与受体结合的药物是？","地西泮"],["与神经轴索变性和损伤相关的新型体液生物标志物是？","神经丝轻链（NfL）"],["员利针的禁忌症包括","以上全是","E"],["孕产妇ards使用糖皮质激素的指征是（）","仅限病毒性肺炎合并休克","B"],["孕妇肺结核用药需调整（）","链霉素替换为乙胺丁醇","B"],["运动对于2型糖尿病患者的益处错误的是（）","降低血压","D"],["运动推荐时机（）","从吃第一口饭算起，在饭后1小时后","A"],["在2022年ada的指南中t2dm患者进行降糖治疗时需多久评估药物治疗方案并根据需要进行调整（）","定期（每3-6个月）","B"],["在2型糖尿病患者中有（）患者合并超重/肥胖？","约60%","B"],["在阿尔茨海默病的早期筛查中哪种影像学检查方法可以排除其他导致痴呆的原因如脑小血管病和血管性痴呆？","头部MRI"],["在病史采集中以下哪项属于“精神行为”方面的评估内容？","抑郁和焦虑、幻觉和妄想"],["在常见认知障碍疾病的临床特点对比中路易体痴呆（dlb）的典型运动症状是？","帕金森征（行动迟缓，步态异常）"],["在痴呆的神经心理学评估中用于评估患者情景记忆的常用测验是？","韦氏记忆量表个人经历分测验"],["在痴呆诊疗中用于评估患者总体退化程度的量表是？","GDS"],["在辅助检查中swi（磁敏感加权成像）主要用于明确？","微出血"],["在呼吸肌力量评估中以下关于最大吸气压（mip）和最大呼气压（mep）的描述哪项是正确的（）","MEP大于100cmH2O表示患者具备良好咳嗽能力","D"],["在结构影像学检查中对于痴呆诊断首选的检查手段是？","MRI"],["在为预防和治疗２型糖尿病而进行的肥胖和体重管理中ａｄａ在２０２２版的指南中推荐的咨询频率和饮食变化是（）","6个月内≥16次会话，实现５００-７５０千卡/天的能量负平衡","A"],["在严重ards患者中推荐使用下列哪种机械通气模式（）","保护性肺通气（低潮气量+高PEEP）","C"],["在英国前瞻性糖尿病研究（ukpds35）显示hba1c每下降1%的益处错误的是（）","致死及非致死卒中下降50%","B"],["在智能障碍基础上出现的与周围环境不协调的愉快体验表情单调刻板的是？","欣快"],["在ad与房颤的关系中以下哪项是两者共有的风险因素？","甲状腺功能亢进","C"],["在ards的诊断及鉴别诊断中以下哪种检查方法可用于明确肺栓塞或间质病变（）","CTPA/HRCT","C"],["在ards治疗过程中何时考虑拔管（）","自主呼吸恢复，氧合稳定，镇静停用后无明显呼吸窘迫","B"],["在ards治疗中俯卧位通气最适用于（）","重度ARDS患者（PaO?/FiO?<150mmHg）","C"],["在aβ的不同形态中哪一种被认为是神经毒性最强且与突触功能障碍关系最密切的？","可溶性Aβ寡聚体"],["在ｂｍｉ大于等于３０．０ｋｇ／ｍ２的二型糖尿病患者中以下哪种治疗方案是合适的选择（）","以上皆是","D"],["在ecmo支持过程中下列哪项措施最重要（）","早期下调机械通气参数，避免肺损伤","C"],["在fdgpet显像中典型的阿尔茨海默病（ad）代谢模式是？","枕顶叶为主，额叶其次"],["诊断ad源性scd的核心条件不包括？","AD生物标志物阴性"],["诊治bpsd的价值不包括？","与认知障碍及日常生活能力下降互不影响"],["中国2020年ad痴呆诊疗指南中ad痴呆临床分级的金标准是？","临床痴呆评定量表（CDR）"],["中国怀堂九针（新九针）针具”这一研究成果于哪一年通过国家鉴定并已在国内外临床运用","1983年","C"],["注射胰岛素的糖尿病患者运动前要注意的是（）","运动前胰岛素注射在腹部","C"],["自身免疫性脑炎（ae）导致的认知障碍通常伴随下列哪组症状？","癫痫、精神障碍"],["ad患者激越发生率随cdr分期变化的趋势是？","逐渐升高"],["ad患者在磁共振波谱成像（mrs）检查中最早期的波谱变化为？","NAA/Cr 比值降低，MI/Cr 比值升高"],["ad疾病修饰疗法（dmt）的核心目的是？","阻断或延缓疾病的进展"],["ad临床症状出现前β淀粉样蛋白（aβ）开始沉积的时间为？","10~20年"],["ad临床症状的abc分类中a代表的是？","日常生活能力受损"],["ad脑结构变化的典型特点是？","早期海马萎缩，晚期全脑萎缩"],["ad诊断后支持管理的五大目标不包括？","立即实现认知功能完全恢复","C"],["ards柏林标准哪项是错误的（）","轻度：PEEP≥5cmH2O时，100mmHg＜PaO2/FiO2≤200mmHg","D"],["ards柏林定义的局限性不包括（）","低氧血症标准需要明确","A"],["ards的病理生理基础不包括以下哪一项（）","肺动脉高压","D"],["ards的发生通常是由多种因素引起的肺损伤属于间接损伤的是（）","输血反应","B"],["ards的发生通常由多种因素引起的肺损伤包括直接性肺损伤和间接性肺损伤下列哪个属于直接性肺损伤（）","肺炎、吸入毒物、肺挫伤、溺水","D"],["ards患者的最佳营养支持策略是（）","适量肠内营养为主，肠外营养为辅","B"],["ards患者机械通气的首要目标是（）","避免呼吸机相关肺损伤（VILI）","C"],["ards患者精神障碍的高发病率与以下哪项因素无关（）","ARDS的严重程度","E"],["ards患者早期最常见的病理生理改变是（）","肺泡水肿","B"],["ards特征性病理变化是（）","肺血管内皮和肺泡损害，肺间质水肿","D"],["ards形态学差异的最直接证据是（）","胸部CT","A"],["ards炎症导致脑损伤的主要机制是（）","炎症介质通过全身循环进入大脑，导致神经元凋亡和海马体损伤","C"],["ards液体管理的目标是（）","适度限制液体，以减少肺水肿","C"],["ards与间质性肺疾病的鉴别要点不包括以下哪一项（）","血流动力学监测","D"],["ards与心源性肺水肿的主要鉴别点不包括以下哪一项（）","血清肌酐水平","E"],["ards预后分类评分(spires)由四个变量组成不包括（）","患者性别","B"],["ards主要的病理生理改变不包括（）","顺应性升高","E"],["aβ的主要清除部位是?","脑部"],["bpsd临床管理的dice过程不包括以下哪项？","药物干预"],["ｄｉｒｅｃｔ研究中体重减轻达到多少的t2dm患者达到了最佳的糖尿病缓解（）","≥１５ｋｇ","D"],["dpp-4抑制剂类药物的作用机制是？","减少肠促胰素（GIP和GLP-1）的降解，增强肠促胰素效应","A"],["ecmo撤机评估的关键指标是（）","左室射血分数>40%","A"],["field研究高tg、低hdl-c亚组分析发现使用非诺贝特可以降低心血管事件达（）%","27","B"],["field研究中在2型糖尿病患者中非诺贝特可降低微血管性截肢（）%","46","C"],["gip（葡萄糖依赖性促胰岛素多肽）由哪种细胞分泌？","十二指肠和空肠的K细胞","C"],["gip通过哪种机制缓解glp-1受体激动剂引起的恶心和呕吐？","通过激动后脑的GIP受体","B"],["mda5抗体阳性患者最突出的临床特征是（）","快速进展性间质性肺病（RP-ILD）","B"],["mes量表主要涵盖哪两个认知域的评估？","记忆与执行功能"],["mscs通过哪种途径抑制局部细胞因子的过度产生从而改善肺损害（）","胆碱能抗炎途径（CAP）","B"],["t2dm患者cvd死亡原因中比例最高的是？","心源性猝死","D"],["tg每升高0.5mmol/l微血管病变风险增加（）糖尿病肾病风险增加（）","16%, 23%","C"]].concat([
