...
const checks = [
  ...
  ['新版播放器问答与签到', /parseClassroomQuiz/.test(source) && /findPlayerPrompt/.test(source)],
  ['考试路由', /handleExam/.test(source)],
  ['结果路由', /handleResult/.test(source)],
  ['登录及考试验证码本机识别', /solveExamCaptcha/.test(source) && /solveLoginCaptcha/.test(source) && /GM_xmlhttpRequest/.test(source)],
  ['证书路由', /handleCertificate/.test(source)],
  ['培训卡路由与无卡任务跳过', /handleCard/.test(source) && /blockedApplications/.test(source)],
